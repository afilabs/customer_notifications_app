...
extension UIAlertController {
    ...
    public func show(atViewController:UIViewController? = nil, animated: Bool = true, vibrate: Bool = false, style: UIBlurEffect.Style? = nil, completion: (() -> Void)? = nil) {
        ...
        DispatchQueue.main.async {
            if atViewController == nil {
                UIApplication.shared.keyWindow?.rootViewController?.present(self, animated: animated, completion: completion)
            }else{
                atViewController?.present(self, animated: animated, completion: completion)
            }
